...
\033[1;36m  ______   ______   ______   __    __   ______  
\033[1;36m /      \ /      | /      \ /  |  /  | /      \ 
\033[1;36m/$$$$$$  |$$$$$$/ /$$$$$$  |$$ |  $$ |/$$$$$$  |
...
\033[1;36m$$/   $$/ $$$$$$/  $$$$$$/  $$/   $$/ $$/   $$/                                                                                                                                                                                                                                                                                                                                                                                                                                    
\x1b[1;30m════════════════════════════════════════════════════════
\033[1;31m▇==➤ ADMIN : AISHA XWD
\033[1;37m▇==➤ GITHUB : ISHU QUEEN
\033[1;31m▇==➤ CREATOR : AISHA KUMARI 
\033[1;37m▇==➤ FACEBOOK : AISHA XWD
\x1b[1;30m════════════════════════════════════════════════════════
...
testPY()
print('''\033[1;32m.═════════RUL3X═>CHOD══════AISHA-XWD════════════════════════════════════════\n''')
def venom():
    clear = "\x1b[0m"
    colors = [35, 33, 36]
    ...
    y = '''
\033[1;33m════════════════════════════════════════════════════════
\033[1;31m N4ME    \033[1;34m: \033[1;33mAISHA QUEEN
\033[1;36m CrEaToR  \033[1;35m: \033[1;34mLEGEND GIRL AISHA QUEEN          
\033[1;31m OWN3R   \033[1;36m: \033[1;35mISHU INSIDE 
\033[1;36m Contact \033[1;33m: \033[1;36m+919919180262
\033[1;33m════════════════════════════════════════════════════════
    ...
    for i in ns:
        try:
            ...
            if s.ok:
                ...
                print (e.strftime("--> AISHA XWD :D | | Date :: %d-%m-%Y  TIME :: %I:%M:%S %p"))
...
if int:    
    ...
    print('''\033[1;32m[•] _ Tool Creator == > [ TH3 LEGEND GIRL AISHA XWD♻️ ]\n''')
...
\033[1;36m$$/   $$/ $$$$$$/  $$$$$$/  $$/   $$/ $$/   $$/                                                                                                                                                                                                                                                                                                                                        
\x1b[1;34m════════════════════════════════════════════════════════
\033[1;31m▇==➤ ADMIN       : ISHU QUEEN
\033[1;32m▇==➤ GITHUB       : AISHA KUMARI
\033[1;30m▇==➤ OWNER       : AISHA XWD
\033[1;32m▇==➤ FACEBOOK   : AISHA QUEEN
\033[1;37m════════════════════════════════════════════════════════""")
    os.system('espeak -a 300 "AYUSH KA LUND DAL BOSDIKE"')
